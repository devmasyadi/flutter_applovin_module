...
class BannerPlatformView(
    ...
    init {
        ...
        applovinMaxAds.showBanner(activity, bannerView, sizeBanner, adUnitId, object : CallbackAds() {
...
class BannerPlatformViewFactory(
    ...
    override fun create(context: Context, viewId: Int, args: Any?): PlatformView {
        ...
        return BannerPlatformView(activity, context, applovinMaxAds, sizeBanner, adUnitId, callbackChannel)
    }
}