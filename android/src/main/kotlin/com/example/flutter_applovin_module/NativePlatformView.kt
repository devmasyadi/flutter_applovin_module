...
class NativePlatformView(
    ...
    init {
        ...
        applovinMaxAds.showNativeAds(activity, nativeView, sizeNative, adUnitId, object : CallbackAds() {
...
class NativePlatformViewFactory(
    ...
    override fun create(context: Context, viewId: Int, args: Any?): PlatformView {
        ...
        return NativePlatformView(activity, context, applovinMaxAds, sizeNative, adUnitId, callbackChannel)
    }
}